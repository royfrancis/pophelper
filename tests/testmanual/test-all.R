...
ftype <- c("sfiles","sfiles1","tfiles","afiles","ffiles",
            "mcfiles","mtfiles","msfiles","tabs1","bfiles")
...
for(i in seq_along(ftype))
{
  ...
  cr <- pophelper:::checkQ(files)
    ...
    # readq --------------------------------------------------------------------
    cat(paste0("readq; "))
    expect_equal(class(pophelper::readQ(files)),"list")
    
    if(unique(cr$type) == "STRUCTURE")
    {
      expect_equal(class(pophelper::readQStructure(files)),"list")
      expect_error(pophelper::readQ(files,filetype="tess"))
      expect_error(pophelper::readQ(files,filetype="basic"))
      expect_error(pophelper::readQ(files,filetype="baps"))
      expect_error(pophelper::readQ(files,filetype="clumpp"))
    }
    
    if(unique(cr$type) == "TESS")
    {
      expect_equal(class(pophelper::readQTess(files)),"list")
      expect_error(pophelper::readQ(files,filetype="structure"))
      expect_error(pophelper::readQ(files,filetype="basic"))
      expect_error(pophelper::readQ(files,filetype="baps"))
      expect_error(pophelper::readQ(files,filetype="clumpp"))
    }
    ...
    {
      expect_equal(class(pophelper::readQBasic(files)),"list")
      expect_error(pophelper::readQ(files,filetype="structure"))
      expect_error(pophelper::readQ(files,filetype="tess"))
      expect_error(pophelper::readQ(files,filetype="baps"))
      expect_error(pophelper::readQ(files,filetype="clumpp"))
    ...
    {
      expect_equal(class(pophelper::readQBaps(files)),"list")
      expect_error(pophelper::readQ(files,filetype="structure"))
      expect_error(pophelper::readQ(files,filetype="tess"))
      expect_error(pophelper::readQ(files,filetype="basic"))
      expect_error(pophelper::readQ(files,filetype="clumpp"))
    ...
    {
      expect_equal(class(pophelper::readQClumpp(files)),"list")
      expect_error(pophelper::readQ(files,filetype="structure"))
      expect_error(pophelper::readQ(files,filetype="basic"))
      expect_error(pophelper::readQ(files,filetype="baps"))
      expect_error(pophelper::readQ(files,filetype="tess"))
    ...
    expect_equal(class(ql),"list")
    expect_equal(class(ql[1]),"list")
    expect_equal(class(ql[[1]]),"data.frame")
    
    # tabulate -----------------------------------------------------------------
    cat(paste0("tabulateq; "))
    
    tr <- pophelper::tabulateQ(qlist=ql,writetable=TRUE)
    ...
    # checks on tabulate obj

    
    # summarise ----------------------------------------------------------------
    cat(paste0("summarise; "))
    
    sr <- pophelper::summariseQ(tr,writetable=TRUE)
    # check if file has been exported
...
#returns dataframe
sr <- summariseQ(tabulateQ(readQ(sfiles)),writetable=FALSE)
...
#check output table sort cluster
plotQ(qlist=readQ(tabs1),imgoutput="join",sortind="Cluster1",sharedindlab=F)
