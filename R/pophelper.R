...
#' @param barbordersize A numeric indicating border size of bars. Defaults to zero. Visible only when \code{barbordercolour} is not NA.
#' @param barbordercolour A single colour for bar border. Defaults to NA. Visible only when \code{barbordersize} is greater than zero and set to a colour other than NA.
...
plotQ <- function(qlist=NULL,imgoutput="sep",clustercol=NA,sortind=NA,grplab=NA,selgrp=NA,ordergrp=FALSE,subsetgrp=NA,grpmean=FALSE,panelspacer=0.06,
                    ...
                    barsize=1,barbordersize=0,barbordercolour="black",
...
plotQMultiline <- function(qlist=NULL,spl=NA,lpp=NA,clustercol=NA,sortind=NA,grplab=NA,selgrp=NA,ordergrp=FALSE,subsetgrp=NA,grpmean=FALSE,
                            ...
                            barsize=0.9,barbordersize=0,barbordercolour="black",
...
#ON LOAD
.onLoad <- function(...) {
  packageStartupMessage("pophelper v2.2.1 ready.")
}
